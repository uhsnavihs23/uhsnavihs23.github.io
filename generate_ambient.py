...
html = get_tailwind_head("Deep Work Ambient Mixer", 2) + get_header(2, 'projects') + '''
    ...
    <script>
        // Verified Google Sound Library URLs (Status 200 OK)
        const SOUNDS = [
            ...
            { id: 'cafe', name: 'Coffee Shop', icon: '☕', color: 'amber', url: 'https://actions.google.com/sounds/v1/ambiences/coffee_shop.ogg' },
            { id: 'fire', name: 'Fireplace', icon: '🔥', color: 'red', url: 'https://actions.google.com/sounds/v1/ambiences/fire.ogg' },
            { id: 'wind', name: 'Howling Wind', icon: '🌬️', color: 'gray', url: 'https://actions.google.com/sounds/v1/weather/strong_wind.ogg' },
            { id: 'ocean', name: 'Ocean Waves', icon: '🌊', color: 'teal', url: 'https://actions.google.com/sounds/v1/water/waves_crashing_on_rock_beach.ogg' },
