...
html_files = [
    os.path.join(base_path, "projects/data-analyst-projects/food-delivery-analytics/index.html"),
    os.path.join(base_path, "projects/data-analyst-projects/customer-shopping-trends/index.html"),
    os.path.join(base_path, "projects/news-app/index.html")
]
...
for filepath in html_files:
    if os.path.exists(filepath):
        ...
        # Inject right before the first global script block at the end
        if '<script data-goatcounter' in content:
            content = content.replace('<script data-goatcounter', standard_footer + '\n<script data-goatcounter')
        
        with open(filepath, 'w') as f:
            f.write(content)

print("Fixed the remaining 3 files!")
