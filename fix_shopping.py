...
filepath = "/Users/shivanshusharma/Documents/AGY_Projects/live_site_repo/projects/data-analyst-projects/customer-shopping-trends/index.html"
with open(filepath, 'r') as f:
    content = f.read()

# The global header and the theme scripts to add
header_html = """
    <!-- Global Header -->
...
# Add "Back to Projects" inside <main>
back_btn = """
...
# Find <main> and insert after it
content = re.sub(r'(<main[^>]*>\s*)', r'\1' + back_btn, content)

with open(filepath, 'w') as f:
    f.write(content)

print("customer-shopping-trends updated")
