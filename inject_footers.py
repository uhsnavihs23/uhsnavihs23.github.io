...
for filepath in html_files:
    ...
    # If it lacks a footer completely
    if "<footer" not in content:
        if "</main>" in content:
            content = content.replace("</main>", "</main>\n" + standard_footer)
        elif '<div class="container' in content:
            # We'll just inject it right before the GoatCounter script or Retro mode script
...
print("Injected footers into files that completely lacked them.")
