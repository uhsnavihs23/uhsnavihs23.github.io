...
<body class="bg-gray-50 text-primary flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 sm:px-6 py-20 w-full">
        ...
        <div class="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-gray-200 mb-12">
            ...
            <!-- Tech Stack -->
            <div class="mb-12">
                <h3 class="text-xl font-bold text-primary mb-4 border-b border-gray-100 pb-2">Tech Stack</h3>
                <div class="flex flex-wrap gap-2">
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">Python</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">JavaScript</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">HTML5</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">CSS3</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">MySQL</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">Power BI</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">Git / GitHub Actions</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">Java</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">C#</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">Markdown / LaTeX</span>
                    <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-lg text-sm font-medium">Arduino</span>
                </div>
            </div>
            ...
            <div class="relative z-10 flex flex-col md:flex-row gap-12">
                <div class="md:w-1/2">
                    ...
                    <div class="bg-gray-800/50 backdrop-blur border border-gray-700 rounded-xl p-6">
                        ...
                        <a href="mailto:shivanshu.sharma0023@gmail.com" class="text-lg md:text-xl font-bold text-accent hover:text-white transition-colors break-words">
