...
<body class="bg-gray-50 text-primary flex flex-col min-h-screen">
    ...
    <main class="flex-grow max-w-4xl mx-auto px-4 sm:px-6 py-12 w-full">
        ...
        <div class="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-gray-200 mb-12">
            ...
            <!-- Tech Stack -->
            <div class="mb-12">
                <h3 class="text-xl font-bold text-primary mb-4 border-b border-gray-100 pb-2">Tech Stack & Tools</h3>
                <div class="flex flex-wrap gap-3 mt-4">
                    <!-- Core Programming -->
                    <img src="https://img.shields.io/badge/python-3670A0?style=plastic&logo=python&logoColor=ffdd54" alt="Python" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/javascript-%23323330.svg?style=plastic&logo=javascript&logoColor=%23F7DF1E" alt="JavaScript" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/java-%23ED8B00.svg?style=plastic&logo=openjdk&logoColor=white" alt="Java" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/c%23-%23239120.svg?style=plastic&logo=csharp&logoColor=white" alt="C#" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/c++-%2300599C.svg?style=plastic&logo=c%2B%2B&logoColor=white" alt="C++" class="shadow-sm hover:scale-110 transition-transform h-7">
                    
                    <!-- Web & Cloud -->
                    <img src="https://img.shields.io/badge/html5-%23E34F26.svg?style=plastic&logo=html5&logoColor=white" alt="HTML5" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/css3-%231572B6.svg?style=plastic&logo=css3&logoColor=white" alt="CSS3" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/tailwindcss-%2338B2AC.svg?style=plastic&logo=tailwind-css&logoColor=white" alt="Tailwind CSS" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/react-%2320232a.svg?style=plastic&logo=react&logoColor=%2361DAFB" alt="React" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/node.js-6DA55F?style=plastic&logo=node.js&logoColor=white" alt="Node.js" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/AWS-%23FF9900.svg?style=plastic&logo=amazon-aws&logoColor=white" alt="AWS" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/docker-%230db7ed.svg?style=plastic&logo=docker&logoColor=white" alt="Docker" class="shadow-sm hover:scale-110 transition-transform h-7">
                    
                    <!-- Data & DB -->
                    <img src="https://img.shields.io/badge/mysql-4479A1.svg?style=plastic&logo=mysql&logoColor=white" alt="MySQL" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/MongoDB-%234ea94b.svg?style=plastic&logo=mongodb&logoColor=white" alt="MongoDB" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/power_bi-F2C811?style=plastic&logo=powerbi&logoColor=black" alt="Power BI" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/Tableau-E97627?style=plastic&logo=Tableau&logoColor=white" alt="Tableau" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/Microsoft_Excel-217346?style=plastic&logo=microsoft-excel&logoColor=white" alt="Excel" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/Colab-F9AB00?style=plastic&logo=googlecolab&color=525252" alt="Google Colab" class="shadow-sm hover:scale-110 transition-transform h-7">

                    <!-- Workflow & Tools -->
                    <img src="https://img.shields.io/badge/git-%23F05033.svg?style=plastic&logo=git&logoColor=white" alt="Git" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/github-%23121011.svg?style=plastic&logo=github&logoColor=white" alt="GitHub" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/jira-%230A0FFF.svg?style=plastic&logo=jira&logoColor=white" alt="Jira" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/Visual%20Studio%20Code-0078d7.svg?style=plastic&logo=visual-studio-code&logoColor=white" alt="VS Code" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/figma-%23F24E1E.svg?style=plastic&logo=figma&logoColor=white" alt="Figma" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/markdown-%23000000.svg?style=plastic&logo=markdown&logoColor=white" alt="Markdown" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/latex-%23008080.svg?style=plastic&logo=latex&logoColor=white" alt="LaTeX" class="shadow-sm hover:scale-110 transition-transform h-7">
                    <img src="https://img.shields.io/badge/-Arduino-00979D?style=plastic&logo=Arduino&logoColor=white" alt="Arduino" class="shadow-sm hover:scale-110 transition-transform h-7">
                </div>
            </div>
        ...
        <div id="contact-card" class="bg-primary text-white rounded-3xl p-8 sm:p-12 shadow-xl relative overflow-hidden mt-12">
            ...
            <div class="relative z-10 flex flex-col md:flex-row gap-12">
                ...
                <div class="md:w-1/2">
                    <!-- USING formsubmit.co FOR REAL EMAIL SUBMISSION WITHOUT NEEDING AN APP -->
                    <form action="https://formsubmit.co/shivanshu.sharma0023@gmail.com" method="POST" class="space-y-4">
                        ...
                        <!-- Success redirect can be set if needed, defaulting to their thank you page -->
