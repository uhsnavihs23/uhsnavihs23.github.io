        ...
        <div class="flex flex-col sm:flex-row gap-12 items-start">
            ...
            <div class="sm:w-2/3 prose prose-lg prose-blue max-w-none text-secondary">
                ...
                <div class="flex flex-wrap gap-4 mt-8">
                    ...
                    <a href="https://github.com/5hivanshu-5harma" target="_blank" class="px-5 py-2.5 bg-white border border-gray-300 text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors">GitHub Profile</a>
                    <a href="https://linkedin.com/in/5hivanshu-5harma-2302" target="_blank" class="px-5 py-2.5 bg-white border border-gray-300 text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors">LinkedIn</a>
                </div>
            </div>
        </div>
    </main>
