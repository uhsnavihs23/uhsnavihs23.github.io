    ...
    <footer class="mt-auto border-t border-gray-200 bg-white py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex gap-4 items-center">
                ...
                <a href="https://linkedin.com/in/uhsnavihs23-2302" target="_blank" class="text-secondary hover:text-accent transition-colors">
        ...
        <div class="flex flex-col sm:flex-row gap-12 items-start">
            ...
            <div class="sm:w-2/3 prose prose-lg prose-blue max-w-none text-secondary">
                ...
                <div class="flex flex-wrap gap-4 mt-8">
                    ...
                    <a href="https://linkedin.com/in/uhsnavihs23-2302" target="_blank" class="px-5 py-2.5 bg-white border border-gray-300 text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors">LinkedIn</a>
                </div>
            </div>
        </div>
    </main>
