        ...
        <div class="flex flex-col sm:flex-row gap-12 items-start">
            ...
            <div class="sm:w-2/3 prose prose-lg prose-blue max-w-none text-secondary">
                ...
                <div class="flex flex-wrap gap-4 mt-8">
                    ...
                    <a href="https://github.com/sharma-shivanshu" target="_blank" class="px-5 py-2.5 bg-white border border-gray-300 text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors">GitHub Profile</a>
                    <a href="https://linkedin.com/in/sharma-shivanshu-2302" target="_blank" class="px-5 py-2.5 bg-white border border-gray-300 text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors">LinkedIn</a>
                </div>
            </div>
        </div>
    </main>
        ...
        <section class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    ...
                    <a href="./ambient-noise/index.html" class="text-accent font-medium hover:underline mt-auto">View App &rarr;</a>
                </div>
                <!-- Pomodoro Timer -->
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <!-- Budget Visualizer -->
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    <h3 class="text-xl font-bold text-primary mb-2">Smart Finance Visualizer</h3>
